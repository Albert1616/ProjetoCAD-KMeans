# Projeto-CAD---K-Means
Projeto final da disciplina de Computação de Alto Desempenho (CAD), no qual foi desenvolvido versões sequencial e paralela do algoritmo de aprendizado de máquina K-Means
=======
# Projeto KMeans C
